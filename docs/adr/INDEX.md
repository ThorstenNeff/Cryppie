...
**ADRs 0001–0019 + 0021–0022 accepted; 0020 reserviert.** (Stand 2026-06-19.) 0001–0013 tragen den Onboarding-Slice; **0014/0015/0016** den Wallet-Core-Slice (PRD-02); **0017** den Portfolio-Slice (PRD-03, on-device); **0018** die WC-Android-Supply-Chain (ratifiziert); **0019** den Send-Slice (`:send`, PRD-02); **0021** den server-seitigen API-Key-Proxy (`:server`, R2/KAN-104); **0022** dessen Prod-Deployment (Mac Mini @ Oakhost, TLS). 0010 trägt ein accepted Portfolio-Update (REST Data/Prices); Auth-Refresh-Feindetails bleiben offen für PRD-08. **0020** ist für die Charting-ADR (PRD-04) reserviert.
